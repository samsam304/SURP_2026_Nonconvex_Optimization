...
sStar = [-2.903534;-2.903534];      % 2D global minimizer/center of approx
...
% % For report 
% exportgraphics(gcf, ...
%     'time_varying_fails_2D_ST_contour.pdf', ...
...
% tightfig();
% exportgraphics(gcf,...
%     'time_varying_fails_2D_ST_mean_traj.pdf',...
%     'BackgroundColor', 'none',...
%     'ContentType', 'vector');
...
% tightfig();
% exportgraphics(gcf,...
%     'time_varying_fails_2D_ST_covariance_eval.pdf',...
%     'BackgroundColor', 'none',...
%     'ContentType', 'vector');
