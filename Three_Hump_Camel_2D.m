...
title('\textbf{Mean Trajectory for Three Hump Camel Objective}','FontSize',title_font_size);
...
legend([gTraj, qgTraj, qTraj, globalMin, localMin1], ...
    {'Nonconvex','Optimal Approximation','Adaptive Approximation','Global Minimizer','Local Minimizer'}, ...
...
figure; box on; hold on; grid on;
title('\textbf{Distance to Optimizer for Three Hump Camel Objective}','FontSize',title_font_size);
...
figure; box on; hold on; grid on;
title('\textbf{Covariance Trajectory for Three Hump Camel Objective}','FontSize',title_font_size);
